...
function twentyseventeen_scripts() {
	...
	// wp_enqueue_style( 'timeline.min', get_theme_file_uri( '/assets/css/timeline.min.css' ), array( 'timeline.min-style' ), '1.0' );
	wp_enqueue_style ('timeline-style', get_template_directory_uri().'/assets/css/timeline.min.css');
	...
	// wp_enqueue_script( 'timeline-min', get_theme_file_uri( '/assets/js/timeline.min.js' ), array( 'timeline' ), '2.1.9', true );
	wp_enqueue_script ('timeline-style', get_template_directory_uri().'/assets/js/timeline.min.js');
